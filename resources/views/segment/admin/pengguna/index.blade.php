...
@include('segment.admin.pengguna.modal.index')
@endsection
...
@section('customJS')
    ...
    <script src="{{ asset('app_js_helper/segment/admin/pengguna/settings.js') }}"></script>
    <script src="{{ asset('app_js_helper/segment/admin/pengguna/controller.js') }}"></script>
    <script src="{{ asset('app_js_helper/segment/admin/pengguna/main.js') }}"></script>
@endsection
