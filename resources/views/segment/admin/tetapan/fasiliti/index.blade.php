...
<div class="content-body">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <table class="fasiliti-table table">
                    <thead>
                    <tr>
                        <th>Nama</th>
                        <th>Tindakan</th>
...
@include('segment.admin.tetapan.fasiliti.modal.index')
@endsection
...
@section('customJS')
    ...
    <script src="{{ asset('app_js_helper/segment/admin/tetapan/fasiliti/settings.js') }}"></script>
    <script src="{{ asset('app_js_helper/segment/admin/tetapan/fasiliti/controller.js') }}"></script>
    <script src="{{ asset('app_js_helper/segment/admin/tetapan/fasiliti/main.js') }}"></script>
@endsection
