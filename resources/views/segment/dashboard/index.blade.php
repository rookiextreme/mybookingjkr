...
@section('CSS')
    <link rel="stylesheet" type="text/css" href="{{ asset('templates/vuexy/app-assets/vendors/css/charts/apexcharts.css') }}">
@endsection

@section('customCSS')
    <link rel="stylesheet" type="text/css" href="{{ asset('templates/vuexy/app-assets/css/pages/dashboard-ecommerce.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('templates/vuexy/app-assets/css/plugins/charts/chart-apex.css') }}">
@endsection
...
@section('JS')
    <script src="{{ asset('templates/vuexy/app-assets/js/scripts/pages/dashboard-ecommerce.js') }}"></script>
@endsection
